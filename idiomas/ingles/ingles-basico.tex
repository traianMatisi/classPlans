...
\subsection{Auxiliar verbs}
	\begin{itemize}
		...
		\item Would - Iria*.
		\item May - Devo.
		\item Might - Talvez (maybe apenas sem verbos e perhaps).
	\end{itemize}
\subsection{Negatives}
	\begin{itemize}
		...
		\item Do not do / Does not do: Modifies the sentence. Works with the auxiliary verb.
		\item Do do / Does do
